...
export class InlineTouch implements Recipe {
    ...
    - Put all new content inside <selected> tags.
    - I only want to see the new code enclosed with the <selected> tags only if you understand my instructions.
    - Do not enclose any part of your answer with <selected> tags if you are not sure about the answer.
    - Only provide me with the code inside <selected> and nothing else.
